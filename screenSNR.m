...
function [SNR_std, SNR_mean,SNR_min,SNR_max] = screenSNR(year,month,day,ScreenRawData) 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%             end
            ...
            for mm = 1:Numofprofile(dd)
                ...
                %debug
                %fprintf('/Users/asta10/Desktop/Research/SkyObservations/%04d%s%02d/RX%d/%s',year,smonth(month,:),day(dd),system,nameofprofile(nn,:))
...
if sum(Numofprofile(1:end)) ~= 0
        ...
        if (ScreenRawData == 1)
                    if (system == 1)
                        saveas(gcf,sprintf('/Users/dacostalindo/Desktop/Research/Results/%s/OverviewStatistics/RayleighStatistics/%s%04d%s%02dstat374nmNew.fig',station,station,year,smonth(month,:),day(1)));
                        print('-depsc2',sprintf('/Users/dacostalindo/Desktop/Research/Results/%s/OverviewStatistics/RayleighStatistics/%s%04d%s%02dstat374nmNew',station,station,year,smonth(month,:),day(1)));
                        print('-djpeg',sprintf('/Users/dacostalindo/Desktop/Research/Results/%s/OverviewStatistics/RayleighStatistics/%s%04d%s%02dstat374nmNew',station,station,year,smonth(month,:),day(1)));
                    elseif (system == 2)
                        saveas(gcf,sprintf('/Users/dacostalindo/Desktop/Research/Results/%s/OverviewStatistics/RayleighStatistics/%s%04d%s%02dstat372nmNew.fig',station,station,year,smonth(month,:),day(1)));
                        print('-depsc2',sprintf('/Users/dacostalindo/Desktop/Research/Results/%s/OverviewStatistics/RayleighStatistics/%s%04d%s%02dstat372nmNew',station,station,year,smonth(month,:),day(1)));
                        print('-djpeg',sprintf('/Users/dacostalindo/Desktop/Research/Results/%s/OverviewStatistics/RayleighStatistics/%s%04d%s%02dstat372nmNew',station,station,year,smonth(month,:),day(1)));
                    end
                elseif (ScreenRawData == 0)
                    if (system == 1)
                        saveas(gcf,sprintf('/Users/dacostalindo/Desktop/Research/Results/%s/OverviewStatistics/RayleighGoodStatistics/%s%04d%s%02dstat374nmGoodNew.fig',station,station,year,smonth(month,:),day(1)));
                        print('-depsc2',sprintf('/Users/dacostalindo/Desktop/Research/Results/%s/OverviewStatistics/RayleighGoodStatistics/%s%04d%s%02dstat374nmGoodNew',station,station,year,smonth(month,:),day(1)));
                        print('-djpeg',sprintf('/Users/dacostalindo/Desktop/Research/Results/%s/OverviewStatistics/RayleighGoodStatistics/%s%04d%s%02dstat374nmGoodNew',station,station,year,smonth(month,:),day(1)));
                    elseif (system == 2)
                        saveas(gcf,sprintf('/Users/dacostalindo/Desktop/Research/Results/%s/OverviewStatistics/RayleighGoodStatistics/%s%04d%s%02dstat372nmGoodNew.fig',station,station,year,smonth(month,:),day(1)));
                        print('-depsc2',sprintf('/Users/dacostalindo/Desktop/Research/Results/%s/OverviewStatistics/RayleighGoodStatistics/%s%04d%s%02dstat372nmGoodNew',station,station,year,smonth(month,:),day(1)));
                        print('-djpeg',sprintf('/Users/dacostalindo/Desktop/Research/Results/%s/OverviewStatistics/RayleighGoodStatistics/%s%04d%s%02dstat372nmGoodNew',station,station,year,smonth(month,:),day(1)));
                    end
        end
        ...
        SNR_std(1,system) = NaN;
        SNR_mean(1,system) = NaN;
        SNR_min(1,system) = NaN;
        SNR_max(1,system) = NaN; 
...
if ScreenRawData == 1
 system = 1;
 fpout = fopen(sprintf('/Users/dacostalindo/Desktop/Research/SkyObservations/%04d%s%02d/RX%d/Goodfilelist.txt',year,smonth(month,:),day(dd),system),'w');
 fprintf(fpout,'%d \n',goodfilescount_374-1);
